...
public class PlayerCamHandle
{
	public final Vector3 pos = new Vector3();
	public Camera cam;
	
	public PlayerCamHandle(Camera cam) {
		this.cam = cam;
	}
	...
	public void move() {
	    ...
	    final float speed = (input.isKeyPressed(Keys.SHIFT_LEFT) ? 60.0f : 12.0f)*delta;
	    ...
	    if (input.isKeyPressed(Keys.SPACE)) {
	    	pos.y += speed;
	    } else if (input.isKeyPressed(Keys.CONTROL_LEFT)) {
	    	pos.y -= speed;
	    }
	    //pos.setZero();
	    this.pos.set(pos);
